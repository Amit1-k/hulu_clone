...
function Header() {
    ...
    const menu=[
        { id:1,name:'Home' }, { id:2, name:'Movies'},{id:3, name:'TV'},{id:4,name:'Series'},{id:5,name:'News' },{id:6,name:'More'},
    ]
  return (
    ...
    >
        ...
        <div className='flex gap-10'>
            ...
            text-gray-300 border-[2px] border-white rounded-full'>Log In</h2>
        </div>
    </div>
  )
}
